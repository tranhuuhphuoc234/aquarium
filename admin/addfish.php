                ...
                <form enctype="multipart/form-data" action="" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col">
                            ...
                            <input type="number" min="0" type="size" class="form-control" id=""
                                aria-describedby="" placeholder="Enter size (cm)" name="size" required>
                        </div>

                        <div class="form-group col">
                            <label for="weight">Weight</label>
                            <input type="number" min="0" type="weight" class="form-control" id=""
                                aria-describedby="" placeholder="Enter weight (g)" name="weight" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col">
